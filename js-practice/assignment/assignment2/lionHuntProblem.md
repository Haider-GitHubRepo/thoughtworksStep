...
console.log("Input: ", testCaseToUse, "Output: ", /* your result here */);
This way you only have to change one value in your code and you can test it easily with a variety of values
